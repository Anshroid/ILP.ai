...
const navigation = [
    ...
    {name: 'Study', href: '#', current: false},
    {name: 'Insight', href: '#', current: false},
    {name: 'Locker', href: '#', current: false},
]
    ...
    return (
        <div className="App">
            <div className="min-h-full">
                                            ...
                                            <div className="ml-10 flex items-baseline space-x-4">
                                                {navigation.map((item) => (
                                                    <a
                                                        ...
                                                        href={item.href}
                                                        onClick={() => {
                                                            navigation.find(_item => _item.name === page).current = false
                                                            setPage(item.name)
                                                            navigation.find(_item => _item.name === item.name).current = true
                                                        }}
                ...
                <main>
                    <div className="mx-auto py-6 sm:px-6 lg:px-8 background">
